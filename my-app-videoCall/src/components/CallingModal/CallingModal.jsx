    ...
    return (
      <div className={styles.overlay}>
        ...
        >
            ...
            >
              {isExpanded ? (
                <svg width="20" height="20" viewBox="0 0 24 24" fill="black">
                  <path
                    d="M8 3V5H5V8H3V5C3 3.89543 3.89543 3 5 3H8Z"
                    fill="currentColor"
                  />
                  <path
                    d="M3 16V19C3 20.1046 3.89543 21 5 21H8V19H5V16H3Z"
                    fill="currentColor"
                  />
                  <path
                    d="M16 3H19C20.1046 3 21 3.89543 21 5V8H19V5H16V3Z"
                    fill="currentColor"
                  />
                  <path
                    d="M21 16V19C21 20.1046 20.1046 21 19 21H16V19H19V16H21Z"
                    fill="currentColor"
                  />
                </svg>
              ) : (
          ...
          {/* Видалено MeetingProvider обгортку - тепер MeetingView отримує контекст ззовні */}
          <MeetingView
            ref={ref}
